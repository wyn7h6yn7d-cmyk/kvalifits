    ...
    <div className="flex flex-col gap-2">
      {items.map((item) => (
        <Link
          ...
          onClick={onNavigate}
          className={cn(
            "flex min-h-11 items-center rounded-lg border px-4 py-3.5 text-[15px] transition-colors",
                  ...
                  <SheetContent>
                    ...
                    <div className="mt-6 space-y-6">
                      ...
                      <div className="border-t border-white/[0.08] pt-4">
                        <div className="mb-2 text-[0.9375rem] font-medium leading-snug text-white/45">
                          {tLang("label")}
                        </div>
                        <LanguageSwitcher className="w-full" triggerClassName="h-11 min-h-11 justify-start px-4 text-[14px] text-white/72" />
                      </div>
