  ...
  return (
    <div className="relative flex min-h-[100dvh] items-start justify-center pt-10 pb-16 lg:min-h-[calc(100dvh-var(--site-header-offset))] lg:pt-16 lg:pb-24">
      ...
      <div className={cn("relative w-full px-4 sm:px-6", maxWidthClassName ?? "max-w-md")}>
        <div className="rounded-3xl border border-white/[0.10] bg-[#14141a] p-5 shadow-[0_24px_80px_-40px_rgba(0,0,0,0.9)] sm:p-8">
          <div className="text-balance text-xl font-semibold tracking-tight text-white sm:text-2xl">
            {title}
          </div>
          {subtitle ? (
