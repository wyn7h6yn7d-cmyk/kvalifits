-- Employer company logo (public URL after upload to Storage).
-- Job posts: only in-app applications; external URL optional field nullable.
...
-- Normalize existing listings to in-app only (Kvalifits apply flow).
