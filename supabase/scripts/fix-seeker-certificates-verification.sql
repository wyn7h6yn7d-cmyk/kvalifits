-- Certificate verification lifecycle for seeker_certificates.
-- Uploads default to `submitted` — never auto-verified.
-- Run in Supabase SQL Editor if profile/apply fails on missing verification columns.
