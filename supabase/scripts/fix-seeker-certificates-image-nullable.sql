-- Fix for: null value in column "certificate_image_url" violates not-null constraint
-- Makes `public.seeker_certificates.certificate_image_url` nullable (idempotent).
